...
VALUES
    ('1990-01-01', 1, 'University A', '123 Main St', 'Alice Admin', 'FEMALE', 'http://img.com/alice.jpg', '1234567890'),
    ('2002-05-10', 2, 'High School A', '456 Pine Rd', 'Bob Student', 'MALE', 'http://img.com/bob.jpg', '2345678901'),
    ('1978-07-15', 3, 'Parent Academy', '789 Oak Ave', 'Carol Parent', 'OTHER', 'http://img.com/carol.jpg', '3456789012'),
    ('1985-12-20', 4, 'IT Institute', '135 Cedar Blvd', 'Dave SysAdmin', 'MALE', 'http://img.com/dave.jpg', '4567890123'),
    ('1993-09-09', 5, 'Event College', '246 Elm St', 'Eve Manager', 'FEMALE', 'http://img.com/eve.jpg', '5678901234'),
    ('2001-04-30', 6, 'High School B', '357 Maple Dr', 'Frank Student', 'MALE', 'http://img.com/frank.jpg', '6789012345'),
    ('2000-11-11', 7, 'High School C', '468 Willow Ln', 'Grace Student', 'FEMALE', 'http://img.com/grace.jpg', '7890123456'),
    ('1980-06-25', 8, 'Parent Institute', '579 Birch Ct', 'Henry Parent', 'MALE', 'http://img.com/henry.jpg', '8901234567'),
    ('1988-03-17', 9, 'Admin School', '680 Aspen Way', 'Ivy Admin', 'FEMALE', 'http://img.com/ivy.jpg', '9012345678'),
    ('1992-08-05', 10, 'Event Academy', '791 Poplar St', 'Jack Manager', 'MALE', 'http://img.com/jack.jpg', '0123456789');
