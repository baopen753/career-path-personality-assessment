...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient clientCredential = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("swd391-client-credentials")
                .clientSecret("{noop}hcibuecuibwqixpjioncuiwdn") // NoOpPasswordEncoder for demo purposes
        ...
        RegisteredClient authCodeClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("swd391-auth-code")
                .clientSecret("{noop}hcibuecuibwqixpjioncuiwsdssasadn") // NoOpPasswordEncoder for demo purposes
        ...
        return new InMemoryRegisteredClientRepository(clientCredential, authCodeClient);
    }
